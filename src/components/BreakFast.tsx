      ...
      <div className="lg:flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-2">
            Buy rare fresh dairies online for the best prices
          </p>
        </div>

        <div className="space-x-4 mt-8 lg:mt-0">
          <button className="feature_btn">Eggs & Dairies</button>
          <button className="text-gray-600 hover:text-color1">Milk</button>
          <button className="text-gray-600 hover:text-color1">Snacks</button>
        </div>
      </div>
